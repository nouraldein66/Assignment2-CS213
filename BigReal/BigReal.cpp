...
int number\_of\_dots {0};
bool no\_digits {true};
...
string first\_before\_dot = "";
string first\_after\_dot = "";
string second\_before\_dot = "";
string second\_after\_dot = "";
...
bool BigReal::operator<(BigReal \&another\_real)  {
if (!(this->isValid()) || !another\_real.isValid()) {
cout << "Invalid terms." << endl;
return false;
}
...
bool compare\_fraction(string s1, string s2) {
int n1 = s1.size();
int n2 = s2.size();
